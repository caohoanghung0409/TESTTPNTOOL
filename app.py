...
with st.container():
    ...
    if st.button("🚀 Bắt đầu xử lý"):
        ...
        st.download_button("📥 Download ALL (ZIP)", data=zip_data, file_name="TPN_COMPLETE.zip")
